                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        if (isset($_SESSION['login_user'])) {
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li class="btn nav-item"><a class="badge rounded-pill text-bg-danger text-decoration-none" href="profile.php">PROFILE</a></li>
                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li class="btn nav-item"><a class="text-decoration-none"
